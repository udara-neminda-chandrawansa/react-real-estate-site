        ...
        <div className="h-[100vh] flex items-start px-3 max-lg:h-fit max-[992px]:flex-col">
            <div className="flex flex-col gap-3 w-1/2 py-2 max-[992px]:w-full">
                ...
                <span className="flex flex-col justify-between gap-8">
                    <h1 className="uppercase text-5xl max-lg:text-4xl leading-snug w-fit">THE ONE APP YOU NEED FOR ALL YOUR PROPERTY NEEDS</h1>
                    {/*big img (hidden after 992px, showen max-[992px])*/}
                    <img className="hidden max-[992px]:flex" src="https://cdn.emaar.com/wp-content/uploads/2023/10/digital-experiance.png" alt="app"></img>
                    <p className="g-font-1 text-xl w-fit">Emaar One allows homeowners and tenants to fully manage their property from their phone anytime anywhere.</p>
                    ...
                    <span className="flex items-center gap-6">
                        <img src="https://cdn.emaar.com/wp-content/uploads/2023/10/emaar-one.png" alt="app"></img>
                        <h1 className="text-3xl p-3 uppercase w-[300px] max-sm:text-2xl">Download Emaar One App</h1>
                    </span>
                    {/*app stores*/}
                    <span className="flex gap-5">
                        <Button>
                            <img src="https://cdn.emaar.com/wp-content/uploads/2023/07/apple.png" alt="app store"></img>
                        </Button>
                        <Button>
                            <img src="https://cdn.emaar.com/wp-content/uploads/2023/07/google-play.png" alt="app store"></img>
                        </Button>
                        <Button>
                            <img src="https://cdn.emaar.com/wp-content/uploads/2023/07/Huawei-app-logo.png" alt="app store"></img>
                        </Button>
                    </span>
                </span>
            </div>
            <div className="flex w-1/2 items-start h-full max-[992px]:hidden">
                <img src="https://cdn.emaar.com/wp-content/uploads/2023/10/digital-experiance.png" alt="app"></img>
            </div>
        </div>
    );
}
