...
function CardType1({ cardHeader, cardHeaderClasses, cardText1, cardText1Classes, cardText2, cardText2Classes, cardImage, cardImageClasses, btnText, extraClasses }) {
    return (
        <div className={`flex flex-col items-center justify-between ${extraClasses}`}>
            ...
            {btnText !== "nobtn" ? <Button displayText={btnText} theme={"dark"} extraClasses={"w-[200px]"} /> : ""}
        </div>
    );
}
